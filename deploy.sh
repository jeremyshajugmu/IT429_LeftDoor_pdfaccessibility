...
deploy_ui() {
    ...
    if ! git clone -b Jeremiah https://github.com/jeremyshajugmu/IT429_LeftDoor_pdfaccessibility "$UI_TEMP_DIR" 2>/dev/null; then
...
GITHUB_URL="https://github.com/jeremyshajugmu/IT429_LeftDoor_pdfaccessibility"
